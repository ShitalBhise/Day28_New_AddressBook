...
public class AddressBookService {
	...
	public void addMultipleContacts(List<Contact> contactsList) {
		...
		contactsList.forEach(addressbookdata -> {
			Runnable task = () -> {
				...
				try {
					this.addNewContact(addressbookdata.getLastName(), addressbookdata.getLastName(),
									addressbookdata.getClass(), addressbookdata.getCity(), addressbookdata.getState(),
